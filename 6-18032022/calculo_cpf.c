...
Quando cpf for inserido, pegamos os 9
primeiros digitos e passamos para o calculo.
É utilizado um número por vez de 10 e indo até 2.
...
digito é 0; caso contrário o resto será subtraido 
por 11.
*/
#include <stdio.h>
